...
- Confgure DNS with AWS Route 53
- Configure a CDN with SSL with AWS CloudFront
'''
...
def setup_domain(domain):
    ...
    print("Domain confgured: http://{}".format(domain))
...
def setup_cdn(domain, bucket):
    ...
    print("Domain confgured: https://{}".format(domain))
